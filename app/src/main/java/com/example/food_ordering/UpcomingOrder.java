...
public class UpcomingOrder {
    ...
    public UpcomingOrder(String documentId, String foodImgUrl, String foodDetailsText, int foodQuantity, double priceValue, String orderNumberText, String pickupTimeText, String orderStatusText, String paymentMethodText) {
